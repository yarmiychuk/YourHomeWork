...
* **В дальнейшем** достаточно пользоваться командами *git push* и *git pull* для отправки и получения изменений, произведённых в локальном, либо удалённом репозитории соответственно